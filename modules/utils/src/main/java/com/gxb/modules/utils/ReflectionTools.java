...
public class ReflectionTools {
	...
	public static Object invokeMethod(final Object obj, final String methodName, final Class<?> parameterTypes, final Object args) {
		return invokeMethod(obj, methodName, new Class<?>[] { parameterTypes }, new Object[] { args });
	}
	...
	public static Field getAccessibleField(final Object obj, final String fieldName) {
		...
		return getField(obj.getClass(), fieldName, true);
	}
	 ...
	 * 如向上转型到Object仍无法找到, 返回null.
	 */
	public static Field getField(final Class<?> clazz, final String fieldName, final boolean isMakeAccessible) {
